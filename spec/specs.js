describe('triangleCheck', function() {
    ...
    it("it should return Isoceles Triangle if only two sides are equal to each other, testing input 1 and input 3 are equal", function() {
        expect(triangleCheck(5,4,5)).to.equal('Isoceles Triangle');
    });
